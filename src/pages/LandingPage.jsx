    ...
    <div>
      ...
      >
        ...
        <div
          style={{
            ...
            height: 120,
            borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(224,123,53,0.35) 0%, transparent 70%)',
            filter: 'blur(8px)',
          }}
        />
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr auto', gap: 56, alignItems: 'center', width: '100%', position: 'relative', zIndex: 1 }}>
          <div>
            ...
            >
              ...
              <span style={{ color: 'rgba(255,255,255,0.55)', fontSize: 12 }}>Reorganização Comportamental</span>
            </div>
            <h1
            ...
            >
              Um caminho para parar de apostar, elaborar suas perdas e reconstruir sua vida — com base em ciência e acolhimento humano.
            </p>
            <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap', animation: 'fadeUp 0.75s 0.16s ease both' }}>
              <Link to="/cadastrar" className="btn-primary" style={{ fontSize: 16, padding: '15px 28px' }}>
              ...
              >
                <div
                  style={{
                    ...
                    height: 44,
                    borderRadius: '50%',
                    background: `linear-gradient(145deg, ${step.color}35, ${step.color}18)`,
      ...
      <section className="section" style={{ background: 'transparent' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
          <h2 style={{ fontFamily: 'DM Serif Display', fontSize: 'clamp(30px, 4vw, 40px)', color: 'var(--navy)', marginBottom: 12 }}>
            Talvez o jogo já esteja afetando sua vida
          </h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 18, marginBottom: 40 }}>
            {symptoms.map((s, i) => (
              ...
              >
                <div className="icon-circle" style={{ width: 44, height: 44, fontSize: 18 }}>
                  ⚠️
                </div>
      ...
      {/* METHOD */}
      <section id="metodo" className="section" style={{ background: 'transparent', paddingTop: 0 }}>
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 22 }}>
            {steps.map((step, i) => (
              <div key={i} className="card" style={{ textAlign: 'center', position: 'relative', overflow: 'hidden', borderRadius: 22, padding: '28px 22px' }}>
      ...
      {/* LOSSES */}
      <section className="section" style={{ background: 'linear-gradient(165deg, #152a45 0%, #1B3558 50%, #0f1f35 100%)', borderRadius: 0 }}>
        <div style={{ maxWidth: 900, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 48, alignItems: 'center' }}>
          <div>
            <h2 style={{ fontFamily: 'DM Serif Display', fontSize: 'clamp(32px, 4vw, 40px)', color: 'white', lineHeight: 1.2, marginBottom: 24 }}>
              ...
              <div key={i} style={{ display: 'flex', gap: 14, alignItems: 'flex-start', marginBottom: 18 }}>
                <div
                  ...
                  style={{
                    ...
                    height: 36,
                    fontSize: 14,
                    background: 'linear-gradient(145deg, rgba(224,123,53,0.35), rgba(224,123,53,0.1))',
      ...
      {/* RESOURCES */}
      <section id="recursos" className="section" style={{ background: 'transparent' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 20 }}>
            {resources.map((r, i) => (
              <div key={i} className="card" style={{ textAlign: 'center', borderRadius: 22, padding: '28px 22px' }}>
                <div
                  className="icon-circle"
                  style={{ margin: '0 auto 18px', width: 56, height: 56, fontSize: 26 }}
                >
                  {r.icon}
                </div>
      ...
      <section
        className="section"
        style={{
          background: 'linear-gradient(145deg, #1a5c62 0%, #1B3558 55%, #0f2240 100%)',
          textAlign: 'center',
          borderRadius: 0,
        }}
      >
        <div style={{ maxWidth: 600, margin: '0 auto' }}>
          <h2 style={{ fontFamily: 'DM Serif Display', fontSize: 'clamp(34px, 5vw, 44px)', color: 'white', marginBottom: 16, lineHeight: 1.15 }}>
            Dê o primeiro passo para uma nova vida.
          </h2>
          <p style={{ color: 'rgba(255,255,255,0.78)', fontSize: 18, marginBottom: 36, lineHeight: 1.65 }}>
            O processo de mudança começa com uma decisão consciente. Estamos aqui para ajudar.
          </p>
          <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link to="/cadastrar" className="btn-primary" style={{ fontSize: 17, padding: '15px 32px' }}>
